...
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "certeye@localhost")
ALERT_RECIPIENTS = [email.strip() for email in os.environ.get("ALERT_RECIPIENTS", "").split(",") if email.strip()]
